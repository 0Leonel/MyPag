...
console.log(cosas);
  ...
  {cosas?.map((item)=>(
               ...
               <div className="relative">
                 ...
                 <div className="text-center py-2 bg-[#344A44]  opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out absolute inset-0 flex flex-col items-center justify-center">
